...
public class FuelSystem extends SubsystemBase {
  ...
  public FuelSystem() {
    ...
    intakeLauncher.configVoltageCompSaturation(VOLT_COMP);
    ...
    feeder.configVoltageCompSaturation(VOLT_COMP);
  ...
  public void setIntakeLauncher(double speed) {
    intakeLauncher.set(TalonSRXControlMode.PercentOutput, speed / VOLT_COMP);
  }

  public void setFeeder(double speed) {
    feeder.set(TalonSRXControlMode.PercentOutput, speed / VOLT_COMP);
  }
